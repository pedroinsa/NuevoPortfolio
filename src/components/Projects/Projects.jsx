...
function Projects() {
    const projects = [{ name: "App de Videogames", image: pi, github: 'https://github.com/pedroinsa/PI-Videogames', text: "Esta App trae información de 100 videojuegos, a partir de los cuales se pueden efectuar filtros de búsqueda y ordenamientos", javascript: true, css: true, html: true, react: true, redux: true, sequelize: true, express: true, postgres: true }, { name: "HenryBooks", image: pf, github: 'https://github.com/scch94/probando-pf', text: "E-commerce de libros que permite navegacion, busquedas y registro de usuario, esencial para comprar libros en la plataforma. Trabajo grupal", javascript: true, html: true, css: true, react: true, redux: true, sequelize: true, postgres: true, express: true }, { name: "Clon Pagina de River", image: river, demo: 'https://riverplate-five.vercel.app/', github: 'https://github.com/pedroinsa/RiverPlate', text: "Clon del home page de la página oficial de River Plate que sirvió para practicar código y fortalecer herramientas.", javascript: true, typescript: true, tailwind: true, css: true, html: true },
    { name: "Rick and Morty", image: rick, demo: 'https://rick-and-morty-fans.vercel.app/', github: 'https://github.com/pedroinsa/Rick-and-Morty', text: "Sitio de noticias de Rick and Morty que incluso trae datos de personajes desde una API", bootstrap: true, typescript: true, css: true, html: true, javascript: true, redux: true }, { name: "Adivinar personaje(Simpsons)", image: simpson, demo: 'https://game-simpson.vercel.app/', github: 'https://github.com/pedroinsa/Simpson', text: "Juego de adivinar el personaje de los Simpson. El jugador tiene 3 intentos para descubrirlo, a medida que obtiene pistas", javascript: true, html: true, css: true, tailwind: true, typescript: true, redux: true }, { name: "Presupuesto", image: presupuesto, demo: "https://presupuesto-eta.vercel.app/ingresar-gastos", github: "https://github.com/pedroinsa/presupuesto", text: "Mini aplicación para calcular presupuestos. Mi primera incursión con Angular", javascript: true, html: true, css: true, bootstrap: true, typescript: true, angular: true }, { name: "Página dedicada a Messi", image: messi, github: "https://github.com/pedroinsa/Messi", demo: "https://messista.vercel.app/", text: "Sitio web dedicado a Messi hecho con Angular y Bootstrap", typescript: true, bootstrap: true, html: true, css: true, angular: true }]
